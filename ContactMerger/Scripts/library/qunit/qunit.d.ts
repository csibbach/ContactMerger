...
interface QUnitStatic extends QUnitAssert {	
    ...
    * 
    * Not exactly sure of the definition but since it is a replacement for test
    * just using a duplicate renamed test function
    * This was custom added and is not available in the github repo :(
    */
